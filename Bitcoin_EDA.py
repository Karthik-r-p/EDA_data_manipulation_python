...
ax = cap10.plot.bar(x='id', y='market_cap_perc', title= TOP_CAP_TITLE, rot=50)
...
ax = cap10.plot.bar(x='id', y='market_cap_usd', logy= True , title= TOP_CAP_TITLE, color=COLORS, rot=50)
